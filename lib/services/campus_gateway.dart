...
/// 当前返回演示数据；接入学校授权接口后替换 [loadSchedule] 的实现即可。
class CampusGateway {
  const CampusGateway();

  Future<List<Course>> loadSchedule() => const DemoCampusGateway().loadCourses();
}

class DemoCampusGateway {
  const DemoCampusGateway();
